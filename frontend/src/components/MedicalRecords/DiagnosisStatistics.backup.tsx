...
import { DiagnosisAPI, type DiagnosisStatistics } from '@/api/medicalRecords';
import { useCurrentUser } from '@/hooks/useAuth';
import { toast } from 'sonner';

const DiagnosisStatistics: React.FC = () => {
    const { data: currentUser } = useCurrentUser();
    const [stats, setStats] = useState<DiagnosisStatistics | null>(null);
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            {stats.topICD10Codes && stats.topICD10Codes.length > 0 ? (
                                stats.topICD10Codes.map((diagnosis, index) => (
